...
public class SpringSecurityConfigurationWSCA extends WebSecurityConfigurerAdapter {
    ...
    protected void configure(HttpSecurity http) throws Exception {
        http.csrf().disable()
                ...
                .antMatchers("/abcflights/admin/**", "/abcflights/users","/abcflights/admin/passengers/**").hasRole("Admin")
                .antMatchers("/abcflights/user/flights**", "/abcflights/passenger/details/{userId}").hasRole("User")
                .antMatchers("/abcflights/news", "/abcflights/login").permitAll()
                .antMatchers("/abcflights/passenger").anonymous()
                .anyRequest()
                .authenticated()
                .and()
                .httpBasic()
